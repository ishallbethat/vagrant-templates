...
cat > "/etc/hosts" << EOF
10.0.2.0    chef-server chef-server.automate.com
EOF
...
/bin/echo -e "chef_server_url  \"https://chef-server.automate.com/organizations/myorganization\"" >> /etc/chef/client.rb
